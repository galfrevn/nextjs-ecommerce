                  ...
                  <button onClick={() => setCartOpen(true)}>
                    <a className="group -m-2 p-2 flex items-center">
                      <ShoppingBagIcon
                        ...
                        aria-hidden="true"
                      />
                      <span className="ml-2 mt-1 text-sm font-medium text-gray-400 group-hover:text-gray-800">
                        {items}
                      </span>
                      ...
                      <div className="mt-6">
                        {cartItems == 0 ? (
                          ...
                          <a
                            ...
                            className="disabled flex justify-center items-center px-6 py-3 border cursor-pointer border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700"
                          >
                            Checkout
                          </a>
                        )}
