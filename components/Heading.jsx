...
export default function Heading() {
  ...
  return (
    <div className="lg:flex lg:items-center max-w-6xl mx-auto lg:justify-between mt-14 ">
      <div className="flex-1 min-w-0">
        <h2 className="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">
          Place your order
        </h2>
        <p className="text-sm text-gray-400 mb-3 mt-1" >Please, check your information</p>
